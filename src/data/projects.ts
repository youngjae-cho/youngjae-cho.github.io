...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blurb: `Implemented reference-free preference optimization for a 12B video-language model the framework couldn't post-train.`,
    problemHtml: `The team entry was a video content-safety VLM on Nemotron-Nano-12B-v2-VL. My piece — the preference-optimization post-training — had no support anywhere in the RL tooling: Nemo-RL couldn't touch Nemotron-Nano-v2-VL.`,
    ownershipHtml: `Team award (Track B, Domain-Specialized Model). Mine within it: the post-training method, its implementation, and the preference data design.`,
    resultHtml: `The RL-aligned model held temporal IoU <b>0.927</b> while internalizing the guardrails; the team took 1st in Track B. Implementation open-sourced as <a href="https://github.com/youngjaecho98/Megatron-Bridge_RL">Megatron-Bridge_RL</a>.`,
    visual: 'gap',
    micro: 'My contribution',
    approachHtml: [
      `<b>Found the gap.</b> Nemo-RL didn't support Nemotron-Nano-v2-VL — no path to preference-optimize the 12B model.`,
      `<b>Implemented SimPO on Megatron-Bridge from scratch</b> — reference-free preference optimization the framework didn't have.`,
    ...
    chips: ['SimPO', 'Preference optimization', 'Megatron-Bridge', 'Nemotron-Nano-12B-VL', 'vLLM'],
  },
  {
    key: 'defect',
